...
enter_tmp
download
wget -q --show-progress http://archive.ubuntu.com/ubuntu/pool/main/o/openssl/"$(curl -sSL http://archive.ubuntu.com/ubuntu/pool/main/o/openssl/ | grep -oP 'libssl1.1_[^"]+?amd64\.deb' | sort -V | tail -n1)"
